...
class App extends Component {
  state = { 
    cards: [
      ...
      {id: 5, nome:"Depeche Mode", prezzo: 450.99, immagine:Depachemode, Totale: 0 }
    ],
    showConcerts: false,  // Stato per mostrare o nascondere i concerti
  };
  ...
  // Funzione per gestire il click sul menu a tendina "Concerti"
  toggleConcerts = () => {
    this.setState({ showConcerts: !this.state.showConcerts });
  }
